...
echo ""
echo "  Observabilidade ↔ Kind (${COMPOSE_NETWORK}):"
echo "    • OTel Collector 172.23.0.50:4318  • Loki 172.23.0.51:3100  • RabbitMQ 172.23.0.52:5672"
echo "  Grafana não está nesta rede — agente no Kind: export GRAFANA_URL=http://host.docker.internal:3000"
echo "  Pods já conseguem enviar OTLP ao Collector (rede Kind + iptables acima)."
